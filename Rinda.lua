...
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1558668590) then RindaTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(1897626429) then RindaTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(Rinda) then RindaTeam = 'البوت' elseif SudoId(user_id) then RindaTeam = 'المطور الاساسي' elseif DevRio:sismember(Rinda..'Rio:RioSudo:', user_id) then RindaTeam = 'المطور الاساسي' elseif DevRio:sismember(Rinda..'Rio:SecondSudo:', user_id) then RindaTeam = 'المطور الاساسي²' elseif DevRio:sismember(Rinda..'Rio:SudoBot:', user_id) then RindaTeam = DevRio:get(Rinda.."Rio:SudoBot:Rd"..chat_id) or 'المطور' elseif DevRio:sismember(Rinda..'Rio:RioConstructor:'..chat_id, user_id) then RindaTeam = 'المالك' elseif DevRio:sismember(Rinda..'Rio:Owner:', user_id) then RindaTeam = 'المالك' elseif DevRio:sismember(Rinda..'Rio:BasicConstructor:'..chat_id, user_id) then RindaTeam = DevRio:get(Rinda.."Rio:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevRio:sismember(Rinda..'Rio:Constructor:'..chat_id, user_id) then RindaTeam = DevRio:get(Rinda.."Rio:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevRio:sismember(Rinda..'Rio:Managers:'..chat_id, user_id) then RindaTeam = DevRio:get(Rinda.."Rio:Managers:Rd"..chat_id) or 'المدير' elseif DevRio:sismember(Rinda..'Rio:Admins:'..chat_id, user_id) then RindaTeam = DevRio:get(Rinda.."Rio:Admins:Rd"..chat_id) or 'الادمن' elseif DevRio:sismember(Rinda..'Rio:VipMem:'..chat_id, user_id) then  RindaTeam = DevRio:get(Rinda.."Rio:VipMem:Rd"..chat_id) or 'المميز' elseif DevRio:sismember(Rinda..'Rio:Cleaner:'..chat_id, user_id) then  RindaTeam = DevRio:get(Rinda.."Rio:Cleaner:Rd"..chat_id) or 'المنظف' else RindaTeam = DevRio:get(Rinda.."Rio:mem:Rd"..chat_id) or 'العضو' end return RindaTeam end
--     Source Rinda     --
...
local url,res = https.request('http://rio.aba.vg/Rinda/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.ChatMember.Rinda ~= true then
Var = false
Text = "*᥀︙عذرا لاتستطيع استخدام البوت !\n᥀︙عليك الاشتراك في قناة السورس اولا :*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="᥀ 𝗗𝗮𝘃𝗶𝗱 : 𝗧𝗲𝗮𝗠 .",url="t.me/Source_Rinda"}}} 
...
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('http://rio.aba.vg/Rinda/Yt.php?Put=Photo&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&UserId='..data.sender_user_id_..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('http://rio.aba.vg/Rinda/Yt.php?Put=Video&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('http://rio.aba.vg/Rinda/Yt.php?Put=Audio&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('http://rio.aba.vg/Rinda/Yt.php?Put=Voice&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
end
...
tdcli_function({ID="GetUser",user_id_=David},function(arg,bot) 
local inline = {
{{text="᥀ المطور .",url="t.me/"..(dp.username_ or "Source_Rinda")}},
{{text="᥀ السورس .",url="https://t.me/Source_Rinda"},{text="᥀ لتنصيب بوت .",url="https://t.me/WYYYYY"}},{{text="᥀ اضفني في مجموعتك .",url="t.me/"..bot.username_.."?startgroup=botstart"}}
}
...
{{text = '᥀ Rinda Team .', url="t.me/Source_Rinda"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..Rinda..'.json', '᥀︙يحتوي الملف على ↫ '..#List..' مجموعه',dl_cb, nil)
...
--     Source Rinda     --
if text == "الرابط" then
if not DevRio:get(Rinda..'Rio:Lock:GpLinks'..msg.chat_id_) then 
if DevRio:get(Rinda.."Rio:Groups:Links"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙Group Link ↬ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"..DevRio:get(Rinda.."Rio:Groups:Links"..msg.chat_id_), 1, "html")
else 
...
--     Source Rinda     --
if text == "الرابط" then
if not DevRio:get(Rinda.."Rio:Lock:GpLinksinline"..msg.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or DevRio:get(Rinda.."Private:Group:Link"..msg.chat_id_) 
...
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevRio:del(Rinda..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع رسائلك', 1, 'md') end
...
Text = [[
Welcome To Source
᥀︙[Rinda Team](https://t.me/Source_Rinda)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ Source Channel',url="https://t.me/Source_Rinda"}},
{{text = '᥀ Developer',url="t.me/WYYYYY"},{text = '᥀ Tws Rinda',url="https://t.me/iA6BOT"}}}
local msg_id = msg.id_/2097152/0.5
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevRio:del(Rinda..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
...
if tonumber(result.id_) == tonumber(1897626429) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
...
if tonumber(result.sender_user_id_) == tonumber(1897626429) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
if text and (text == "متحركه" or text == "↫ متحركه ᥀") and not DevRio:get(Rinda..'Rio:gif:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/GifRinda/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Rinda     --
...
if text and (text == "ميمز" or text == "↫ ميمز ᥀") and not DevRio:get(Rinda..'Rio:memz:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/MemzRinda/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Rinda     --
...
if text and (text == "غنيلي" or text == "↫ غنيلي ᥀") and not DevRio:get(Rinda..'Rio:Audios:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/AudiosRinda/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Rinda     --
...
if text and (text == "اغنيه" or text == "↫ اغنيه ᥀" or text == "اغاني") and not DevRio:get(Rinda..'Rio:mp3:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/RindaMp3/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Rinda     --
...
if text and (text == "ريمكس" or text == "↫ ريمكس ᥀") and not DevRio:get(Rinda..'Rio:Remix:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text and (text == "صوره" or text == "↫ صوره ᥀") and not DevRio:get(Rinda..'Rio:Photo:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text and (text == "انمي" or text == "↫ انمي ᥀") and not DevRio:get(Rinda..'Rio:Anime:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text and (text == "مسلسل" or text == "↫ مسلسل ᥀") and not DevRio:get(Rinda..'Rio:Series:Rio'..msg.chat_id_) and SourceCh(msg) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, RindaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Rinda.."Rio:Lock:Key"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, RindaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Rinda.."Rio:Lock:Key"..msg.chat_id_)
return false  
end
end
--     Source Rinda     --
...
local List = DevRio:smembers(Rinda..'Rio:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
...
local List = DevRio:smembers(Rinda.."Rio:Sudo:AllRed")
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود مضافه" ,  1, "md")
return false
end end
...
if text and text:match('^بحث (.*)$') and not DevRio:get(Rinda.."Rio:WhyTube"..msg.chat_id_) then            
local Text = text:match('^بحث (.*)$') 
local msg_id = msg.id_/2097152/0.5 
https.request('http://rio.aba.vg/Rinda/Yt.php?Put=Search&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source Rinda     --
if SecondSudo(msg) then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/RindaTeam/RindaFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/RindaTeam/RindaFiles/master/RindaFiles/"..FileName)
if Res == 200 then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ قناة السورس',url="t.me/Source_Rinda"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Source_Rinda&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ مبرمج السورس',url="t.me/WYYYYY"}},
}
local msg_id = msg.id_/2097152/0.5
